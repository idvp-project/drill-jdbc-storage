 ...
 */
package org.apache.calcite.sql.clickhouse;
 ...
 * <p>
 * todo: Удалить при наличии стандартной реализации.
 */
public class ClickHouseSqlDialect extends SqlDialect {
    public static final SqlDialect DEFAULT = new ClickHouseSqlDialect(EMPTY_CONTEXT
     ...
     */
    private ClickHouseSqlDialect(Context context) {
        super(context);
    }
